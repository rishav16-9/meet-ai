    ...
    <div className="flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        <div className="rounded-lg bg-white border px-3">
          <ScrollArea>
            <TabsList className="p-0 bg-background rounded-none justify-start h-13">
              <TabsTrigger
                value="summary"
                className="text-muted-foreground bg-background rounded-none data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
              >
                <BookOpenTextIcon />
                Summary
              </TabsTrigger>
        ...
        <TabsContent value="summary">
          <div className=" border bg-white rounded-lg">
            <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
              ...
              <Badge
                variant="outline"
                className="flex items-center gap-x-4 [&>svg]:size-4"
              >
                <ClockFadingIcon />
